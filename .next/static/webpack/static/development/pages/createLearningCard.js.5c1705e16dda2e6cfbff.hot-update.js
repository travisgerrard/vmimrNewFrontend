    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_mentions__WEBPACK_IMPORTED_MODULE_1__["MentionsInput"], {
        ...
        displayTransform: function displayTransform(id) {
          var userWithId = _this2.props.users.filter(function (user) {
            return user.id === id;
          });
          ...
          if (userWithId.length) {
            return "@[".concat(userWithId[0].display, "](").concat(userWithId[0].id, ")");
          }
        },
        __source: {
...
//# sourceMappingURL=createLearningCard.js.5c1705e16dda2e6cfbff.hot-update.js.map